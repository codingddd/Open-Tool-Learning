...
class ToolSearcher(API):
    ...
    def __init__(self):
        ...
        apis_dir = '/public/home/wlchen/hhan/open-tool-learning/code/execute_tool/api-bank/lv3_apis'
    ...
    def best_match_api(self, keywords):
        ...
        model = SentenceTransformer('/public/home/wlchen/hhan/open-tool-learning/code/execute_tool/api-bank/paraphrase-MiniLM-L3-v2')
